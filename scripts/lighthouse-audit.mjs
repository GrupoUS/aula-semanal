...
/**
 * Lighthouse audit for the Aula OTB landing.
 *
 * Usage:
...
// Rotas públicas desta instância. `/otb` era resíduo do fork do `otb-usa` e
// auditava um 404.
const PAGES = ["/", "/termos", "/politica-de-privacidade"];
const THRESHOLD = 95;
