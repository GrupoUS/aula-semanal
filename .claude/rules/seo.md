...
> Project-specific values (canonical URL, contact phone, social handles) live in `.graph-powers/config.json::project` or the project skill.
...
| Canonical URL / contact phone / social handles | `.graph-powers/config.json::project` or project skill |
