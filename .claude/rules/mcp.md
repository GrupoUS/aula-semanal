...
Do not add backend, DB or payments MCPs without an explicit requirement. This repo is a static landing de inscrição (aula gratuita do OTB); lead via form → Apps Script Web App → planilha Google, com fallback WhatsApp. Sem banco de dados.
